...
public class testRecommend {
	...
	public static void main(String[] args) {
		...
		for (Entry<String, Map<String, Integer>> userPerfEn1 : userPerfMap.entrySet()) {
			for (Entry<String, Map<String, Integer>> userPerfEn2 : userPerfMap.entrySet()) {
				String userName = userPerfEn2.getKey();
				if (!userPerfEn1.getKey().equals(userName)) {
					double sim = getUserSimilar(pref5, userPerfEn2.getValue());
					double distance = getEuclidDistance(pref5, userPerfEn2.getValue());
					output1 = userPerfEn1.getKey() + "与" + userName + "之间的相关系数:" + sim + ",";
					output2 = userPerfEn1.getKey() + "与" + userName + "之间的距离:" + distance + ",";
